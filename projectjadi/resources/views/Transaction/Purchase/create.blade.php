            ...
            <div class="col-md-12">
                ...
                <form class="form-horizontal" method="POST" action="{{route('purchase-order.store')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="hidden" readonly="true" class="form-control" name="id_raw_product_[]" id="id_raw_product_1" placeholder="Product Name">
                            <input readonly="true" type="text" class="form-control" name="name_raw_product_[]" id="name_raw_product_1" placeholder="Product Name">
                        </div>
                        <div class="col-sm-2">
        ...
        $(addButton).click(function (){
            ...
            $(wrapper).append('<div class="form-group row">'+
                         '<div class="col-sm-3">'+
                            ...
                            '<input readonly="true" type="text" class="form-control" name="name_raw_product[]" id="name_raw_product_'+X+'" placeholder="Product Name">'+
                        '</div>'+
                        '<div class="col-sm-2">'+
